...
export const messagesEn: Record<string, string> = {
	...
	'aiEmployees.onboarding.resetAction': 'Start over',
	'aiEmployees.onboarding.resetConfirm':
		'Discard the current onboarding data for this workspace and start again from the company step?',
	...
	'aiEmployees.role.nationality': 'Nationality / tone',
	'aiEmployees.role.mbti': 'MBTI',
	'aiEmployees.role.mbtiHint': 'Choose a personality to shape style and avatar',
	...
	'aiEmployees.role.teamReviewDesc': 'Edit each role before creation. You can change reporting lines, tone, MBTI, and prompt.',
